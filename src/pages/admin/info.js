...
function Info() {
    ...
    function Save() {
        if (empId == "") {
            ...
            axios.post(process.env.REACT_APP_EDIT_EMPLOYEE, {
                empid: empId,
                firstname: firstName,
                lastname: lastName,
        ...
        if (file) {
            ...
            try {
                const res = await axios.post(
                    process.env.REACT_APP_UPLOADING,
                    formData
                );
            ...
            <div id="full_frame">
                ...
                <div ref={ref_imageFrame} className="modal">
                    <div className="modal-content">
                        ...
                        <center>
                            <img ref={ref_newimage} id="photo-upload-visible1" src={image} alt="Profile" accept="image/*"></img>
                ...
                <div ref={ref_dashboard} id="body">
                    <div className="profile">
                        ...
                        <Figure>
                            <Figure.Image
                                id="photo-upload"
                                alt="Profile"
                                src={process.env.REACT_APP_IMAGEURL + Profile}
                                onClick={UploadImage}
                            />
                        </Figure>
                    </div>
                    ...
                    <div id='name'>
                        ...
                        <input disabled ref={ref_zipcode} id="zipcode" className="form" type="number" maxLength={6} pattern="[0-9]{6}" onChange={(e) => setZipcode(e.target.value)} value={Zipcode} name="Zipcode" placeholder="123456"></input>
                    </div>
                    {renderErrorMessage("ZIPCODE")}
                    <div id='name'>
                        <label htmlFor="MobileNO">Mobile Number</label>
                        <input disabled ref={ref_mobile} id="mobileno" className="form" type="number" maxLength={10} pattern="[0-9]{10}" onChange={(e) => setMobileNO(e.target.value)} value={MobileNO} name="MobileNO" placeholder="1234567890"></input>
                    </div>
